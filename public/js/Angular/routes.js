OraSchool.config(function($routeProvider,$locationProvider) {
    ...
    .when('/vclassschedule', {
        templateUrl : 'assets/templates/vclassschedule.html',
        controller  : 'vclassScheduleController',
        resolve: {
            essentialData: function(srvLibrary) {
                return srvLibrary.getEssentials();
            }
   ...
   .when('/materials/:subjectId', {
        templateUrl : 'assets/templates/materials_subjects.html',
        controller  : 'materialsController',
        resolve: {
            essentialData: function(srvLibrary) {
                return srvLibrary.getEssentials();
