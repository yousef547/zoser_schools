            ...
            <div class="card-body">
                <div class="row my-2">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form method="post" action="{{route('board.update',$newsboard->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3 row">
                                <div class="col-sm-12">
                                    <label class="form-label pt-0">{{$newLang->newsTitle}}</label>
                                    <input class="form-control" type="text" name="newsTitle" value="{{$newsboard->newsTitle}}" placeholder="{{$newLang->newsTitle}}">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="newsText" rows="4" placeholder="{{$newLang->newsContent}}">{{$newsboard->newsText}}</textarea>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-select" name="newsFor">
                                        ...
                                        <option {{$newsboard->newsFor == $role->id ? "selected":" "}} value="{{$role->id}}">{{$role->role_title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" name="newsDate" value="{{$newsboard->newsDate}}" type="date" id="example-date-input">
                                </div>
                            </div>
                            <div class="">
                            ...
                            <div class="form-check my-2">
                                <input type="radio" id="customRadio1" {{$newsboard->fe_active == 1 ? "checked":" "}} name="fe_active" value="1" class="form-check-input" >
                                <label class="form-check-label" for="customRadio1">{{$newLang->Active}}</label>
                            </div>

                            <div class="form-check my-2">
                                <input type="radio" id="customRadio2" name="fe_active" value="0" class="form-check-input"  {{$newsboard->fe_active != 1 ? "checked":" "}}>
