                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form action="{{route('level.submit')}}" method="POST">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    <input class="form-control" type="text" id="subject2" name="level" placeholder="level">
                                                </div>
                                                <div class="col-sm-6">
                                                    <input class="form-control" type="text" id="subject2" name="lavel_name" placeholder="level name">
                                                </div>
                                            </div>
