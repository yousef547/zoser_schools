            ...
            <div class="card-body">
                <div class="row my-2">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form method="post" action="{{route('catehostel.submit')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3 row">
                                <div class="col-sm-12">
                                    <label class="form-label pt-0">{{$newLang->catTitle}}</label>
                                    <input class="form-control" type="text" name="catTitle" placeholder="{{$newLang->catTitle}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-select" name="catTypeId">
                                        ...
                                        <option value="{{$hostel->id}}">{{$hostel->hostelTitle}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" name="catFees" type="text" placeholder="{{$newLang->fees}}">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label pt-0">{{$newLang->Notes}}</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="catNotes" rows="4" placeholder="{{$newLang->Notes}}"></textarea>
                            </div>
