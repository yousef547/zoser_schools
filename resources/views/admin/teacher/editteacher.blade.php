    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">{{$newLang->EditTeacher}}</h4>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card" data-select2-id="8">
            <div class="card-body" data-select2-id="7">
                ...
                <form method="post" action="{{url('/admin/teacher/update')}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                            <input class="form-control" type="text" name="fullName" value="{{$user->fullName}}" placeholder="{{$newLang->FullName}}">
                        </div>
                    </div>
                    <label class="form-label">{{$newLang->username}} *</label>
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                            <input class="form-control" type="text" name="username" value="{{$user->username}}" placeholder="{{$newLang->username}}">
                        </div>
                    </div>
                    <label class="form-label">{{$newLang->email}} *</label>
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                            <input class="form-control" type="text" name="email" value="{{$user->email}}"  placeholder="{{$newLang->email}}">
                        </div>
                    </div>
                    <label class="form-label">{{$newLang->password}} *</label>
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                            <input class="form-control" type="text" name="address" value="{{$user->address}}" id="subject2" placeholder="{{$newLang->Address}}">
                        </div>
                    </div>
                    <label class="form-label">{{$newLang->zoomLink}}</label>
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                            <input class="form-control" type="text" name="zoomLink" value="{{$user->zoomLink}}" placeholder="{{$newLang->zoomLink}}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                            <input class="form-control" type="number" name="biometric_id" value="{{$user->biometric_id}}"  placeholder="{{$newLang->bioId}}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                            <input class="form-control" type="text"  value="{{$user->user_position}}" name="user_position" id="subject2" placeholder="{{$newLang->userPosition}}">
                        </div>
                    </div>
