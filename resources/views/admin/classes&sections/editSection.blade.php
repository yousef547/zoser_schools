                    ...
                    <div class="table-responsive">
                        ...
                        <form method="POST" action='{{url("admin/section/editSection/$section->id")}}'>
                            ...
                            <div class="form-group ">
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" value="{{$section->sectionName}}" name="sectionName" placeholder="Class name">
                                </div>
                            </div>
                            <label class="col-sm-2 text-right control-label col-form-label ng-binding">Section Title * </label>
                            <div class="form-group ">
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" value="{{$section->sectionTitle}}" name="sectionTitle" placeholder="Section Title ">
                                </div>
                            </div>
