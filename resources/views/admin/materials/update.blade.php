                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <form method="POST" action="{{url('admin/materials/edit')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" name="material_title" value="{{$oneRow->material_title}}" placeholder="{{$newLang->materialTitle}}">
                                            </div>
                                        </div>
                                        <label for="example-text-input" class="col-sm-2 form-label">{{$newLang->materialDesc}}</label>
                                        <div class="mb-3 row">
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" value="{{$oneRow->material_description}}" name="material_description" placeholder="{{$newLang->materialDesc}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-sm-2 form-label">{{$newLang->section}}</label>
                                            <div class="col-sm-12">
