    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">{{$newLang->students}}</h4>
            </div>
        </div>
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="mb-3">{{$newLang->admission}}</h5>
                    <div>
                        <form method="POST" action="{{url('admin/student/submit')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="">
                                        <input class="form-control" type="text" value="" name="religion" placeholder="{{$newLang->religion}}">
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class=" col-md-6">
                                    <label for="example-email-input1" class="form-label pt-0">{{$newLang->Upload}}</label>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="">
                                        <input class="form-control" type="number" value="" name="biometric_id" placeholder="{{$newLang->bioId}} ">
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="example-email-input1" class="form-label pt-0">{{$newLang->admNumber}}</label>
                                    <div class="">
                                        <input class="form-control" type="number" value="" name="Admission_Number" placeholder="{{$newLang->admNumber}}">
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="col-md-12 mt-5">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="">
                                                <input type="text" name="medical[Policy]" class="form-control " placeholder="{{$newLang->insPolicy}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="">
                                                <input type="text" name="medical[Weight]" class="form-control " placeholder="{{$newLang->Weight}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label pt-0">{{$newLang->height}} </label>
                                            <div class="">
                                                <input type="text" name="medical[Height]" class="form-control " placeholder="{{$newLang->height}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label pt-0">{{$newLang->disType}}</label>
                                            <div class="">
                                                <input type="text" name="medical[Disability]" class="form-control " placeholder="{{$newLang->disType}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="">
                                                <input type="text" name="medical[Contact]" class="form-control " placeholder="{{$newLang->contactInfo}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mt-5">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="">
                                                <input type="text" name="father[Name]" class="form-control"  placeholder="{{$newLang->fatheName}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label pt-0">{{$newLang->motherName}} </label>
                                            <div class="">
                                                <input type="text" name="mother[Name]" class="form-control " placeholder="{{$newLang->motherName}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label pt-0">{{$newLang->fatherMob}}</label>
                                            <div class="">
                                                <input type="text" name="father[mobile]" class="form-control " placeholder="{{$newLang->fatherMob}}<">
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label pt-0">{{$newLang->motherMob}}< </label>
                                            <div class="">
                                                <input type="text" name="mother[mobile]" class="form-control " placeholder="{{$newLang->motherMob}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="">
                                                <input type="text" name="father[Job]" class="form-control " placeholder="{{$newLang->fatherJob}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label pt-0">{{$newLang->motherJob}} </label>
                                            <div class="">
                                                <input type="text" name="mother[Job]" class="form-control " placeholder="{{$newLang->motherJob}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="">
                                                <input type="text" name="father[notes]" class="form-control "  placeholder="{{$newLang->fatherNotes}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label pt-0">{{$newLang->motherNotes}} </label>
                                            <div class="">
                                                <input type="text" name="mother[notes]" class="form-control " placeholder="{{$newLang->motherNotes}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
