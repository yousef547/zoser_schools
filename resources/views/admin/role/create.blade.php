                    ...
                    <div class="row">
                        ...
                        <form method="POST" action="{{route('role.submit')}}">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <textarea name="role_description" class="form-control" placeholder="Role Description"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <div class="radio-list">
                                            <label>
                                                <input type="radio" name="def_for" value="none" required="" class=""> None
                                            </label>
                                        </div>
                                        <div class="radio-list">
                                            <label class="ng-binding">
                                                <input type="radio" name="def_for" value="teacher" required="" class=""> Teacher
                                            </label>
                                        </div>
                                        <div class="radio-list">
                                            <label class="ng-binding">
                                                <input type="radio" name="def_for" value="student" required="" class=""> Student
                                            </label>
                                        </div>
                                        <div class="radio-list">
                                            <label class="ng-binding">
                                                <input type="radio" name="def_for" value="parent" required="" class=""> Parent
                                            </label>
                                        </div>
                                        <div class="radio-list">
                                            <label class="ng-binding">
                                                <input type="radio" name="def_for" value="admin" required="" class=""> Administrators
                                            </label>
                                        </div>
                                    </div>
                                </div>
