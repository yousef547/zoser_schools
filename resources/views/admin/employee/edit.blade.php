        ...
        <div class="card" data-select2-id="8">
            <div class="card-body" data-select2-id="7">
                ...
                <form method="post" action="{{url('/admin/employee/update')}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                            <input class="form-control" type="text" value="{{$user->fullName}}" name="fullName"  placeholder="Full Name">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-12">
                            <input class="form-control" value="{{$user->address}}" type="text" name="address" id="subject2" placeholder="Address">
                        </div>
                    </div>
